...
const CLOOK = () => {
  ...
  const simulateCLOOK = () => {
    ...
    let seq = [headPos];
    const left = reqArr.filter((r) => r < headPos).sort((a, b) => a - b);
    ...
    if (direction === "up") {
      ...
      if (right.length > 0) seq.push(...right.reverse());
    }
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 md:p-12 flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-6 text-indigo-700">CLOOK Disk Scheduling</h1>
