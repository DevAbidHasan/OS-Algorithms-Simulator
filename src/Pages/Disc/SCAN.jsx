...
const SCAN = () => {
  ...
  const simulateSCAN = () => {
    ...
    const seq = [headPos];
    let left = reqArr.filter((r) => r < headPos).sort((a, b) => b - a);
    let right = reqArr.filter((r) => r >= headPos);
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 md:p-12 flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-6 text-indigo-700">SCAN Disk Scheduling</h1>
