...
const CTA = () => {
    ...
    },
    {
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle cx="7.5" cy="7.5" r="7.5" fill="#5C67FF" />
        </svg>
      ),
      text: "Used in Top Universities",
    },
    {
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <rect width="15" height="15" rx="3" fill="#5C67FF" />
        </svg>
      ),
      text: "Loved by Students",
    },
  ];
  ...
  return (
    <div
      id="cta"
      className="max-w-5xl mt-20 mb-40 mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30"
    >
      <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">
        <div className="flex flex-wrap items-center justify-center gap-2 mb-3">
          {badges.map((badge, idx) => (
            <div
              key={idx}
              className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs"
            >
              {badge.icon}
